...
//
// Toda la lógica de los experimentos  vive en include/experimentos.hh como
// plantillas. Aquí solo se instancia esa batería con la clase SplayTree. El
// driver gemelo experimentos_avl.cc hace lo mismo con AVL y, gracias a la misma
// semilla/c/λ del header, ambas estructuras quedan medidas sobre datos
// idénticos y son comparables.
//
//   Compilar:  g++ -O2 -std=c++17 -static experimentos_splay.cc -o experimentos_splay.out
//   Ejecutar:  ./experimentos_splay.out
//   Extenso:   g++ -O2 -std=c++17 -static -DEXP_73=25 experimentos_splay.cc -o experimentos_splay.out
//
